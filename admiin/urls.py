...
from .views import Admin_index, CategoryCreateView, baseview, EquipmentCreateView, ProductDetailView, ProductUpdateView, ProductDeleteView, ResponsibleCreateView, ModelCreateView, SearchResultsView, AdminCategories, AdminCategoryEdit, AdminCategoryDelete, AdminModels, AdminModelEdit, AdminModelDelete, AdminResponsibles, AdminResponsibleEdit, AdminResponsibleDelete, AdminRooms, AdminRoomDetail
